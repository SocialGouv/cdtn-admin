...
SET "content" = 'Les personnes dites « vulnérables à la Covid-19 » peuvent reprendre leur activité professionnelle en présentiel, en bénéficiant de mesures particulières de protection. Le recours au télétravail, lorsque le poste le permet, est également une option possible.

Pour en savoir plus consultez notre page [Personnes vulnérables : accompagnement de la reprise d''activité](https://code.travail.gouv.fr/information/personnes-vulnerables-reprise-dactivite-ou-activite-partielle)'
WHERE id = '0d23359f-ac4b-4b84-9140-eae0f802f99c';
UPDATE information.informations_contents_blocks
SET "content" = '**La vaccination**
...
L’ensemble de ces mesures est rappelé dans le document de recommandations sanitaires générales publié sur le site du ministère de la santé et des solidarités, [cliquez ici](https://solidarites-sante.gouv.fr/soins-et-maladies/maladies/maladies-infectieuses/coronavirus/etat-des-lieux-et-actualites/) pour y accéder.
...
- [Que faire si on a été en contact avec une personne positive au Covid-19 ?](https://www.ameli.fr/assure/covid-19/symptomes-gestes-barrieres-cas-contact-et-isolement/en-cas-de-contact-avec-une-personne-malade-du-covid-19)
- [Que faire en cas de test positif au Covid-19 ?](https://www.ameli.fr/assure/covid-19/symptomes-gestes-barrieres-cas-contact-et-isolement/en-cas-de-test-positif-au-covid-19)
...
Dans un délai de 21 jours au plus à compter de la réception du dossier complet par la DREETS.
Les salariés sont informés de cette décision par tout moyen.
...
Si aucun poste de reclassement n’est disponible ou si le salarié refuse l’ensemble des postes proposés, l’employeur le convoque à un entretien préalable.
La convocation est réalisée par lettre recommandée avec accusé de réception ou remise en main propre contre décharge.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Consultez le [Questions-Réponses](https://travail-emploi.gouv.fr/actualites/l-actualite-du-ministere/article/acces-des-salaries-et-representants-du-personnel-aux-zones-securisees-durant) élaboré par le ministère du Travail, de la Santé et des Solidarités pour répondre aux principales questions soulevées.'
WHERE id = 'ddfc829c-3ff1-4af2-8225-06170c23b7e0';
UPDATE information.informations_contents_blocks
SET "content" = 'Lorsque l’état de santé (mental ou physique) d’un salarié est devenu incompatible avec le poste qu’il occupe, le médecin du travail peut prononcer une inaptitude médicale.
Cet avis d’inaptitude impose à l’employeur de rechercher un poste compatible avec l’état de santé du salarié (reclassement). Par ailleurs, s’il ne dispose d’aucun poste adapté, ou si le salarié refuse le poste proposé, l’employeur pourra procéder au licenciement de son salarié.
...
Le contrat est rompu à la date de notification du licenciement. L’employeur doit rendre disponibles les documents de fin de contrat afin que le salarié puisse les obtenir.
Le salarié n’exécute pas de préavis, mais cette durée est tout de même prise en compte pour calculer son indemnité de licenciement. Ce préavis débute à la première présentation de la lettre de licenciement.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le nouveau texte instaure **des nouveaux droits applicables à l’ensemble des salariés de la branche** (quel que soit le métier exercé par les salariés rattachés à cette branche) :
...
UPDATE information.informations_contents_blocks
SET "content" = '### La négociation d’un APC
...
Si l’accord ne prévoit rien, l’employeur doit réaliser un abondement d’un montant de 3000 euros minimum sur [le compte personnel de formation](https://www.moncompteformation.gouv.fr/espace-prive/html/#/) du salarié concerné.
...
UPDATE information.informations_contents_blocks
SET "content" = '-   Augmentation du salaire horaire brut par enfant ;
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le salarié peut bénéficier d’un examen par le médecin du travail ou un infirmier de santé au travail, à sa demande, à celle de son employeur ou du médecin du travail, indépendamment des visites obligatoires (par exemple lorsqu’il anticipe un risque d’inaptitude).'
WHERE id = '571fb1cb-fbdb-41d6-944c-f5e99061e784';
UPDATE information.informations_contents_blocks
SET "content" = 'Le grand licenciement pour motif économique, impliquant la mise en place du congé de reclassement, concerne le licenciement d’au moins 10 salariés (sur une période de 30 jours) pour motif économique au sein d’une entreprise sans CSE de moins de 50 salariés appartenant à un groupe (français ou européen) employant au moins 1000 salariés.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le recours à **la rupture conventionnelle n’est pas possible**.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le recours à **la rupture conventionnelle est possible**, y compris lorsque le contrat de travail est suspendu (exemple : maladie du salarié).
...
Pour en savoir plus sur la rupture conventionnelle en général, vous pouvez cliquer [ici](https://code.travail.gouv.fr/fiche-service-public/rupture-conventionnelle).
'
WHERE id = 'bc7d71bc-613a-49aa-923e-4337f1fbc98a';
UPDATE information.informations_contents_blocks
SET "content" = 'L’abandon de poste se définit comme l’absence non justifiée du salarié à son poste de travail.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le petit licenciement collectif pour motif économique, impliquant la mise en place du congé de reclassement, concerne le licenciement de 2 à 9 salariés (sur une période de 30 jours) pour motif économique au sein d’une entreprise sans CSE d’au moins 1000 salariés ou appartenant à un groupe (français ou européen) employant au moins 1000 salariés.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le petit licenciement pour motif économique dans une entreprise sans CSE, impliquant la mise en place du contrat de sécurisation professionnelle, concerne le licenciement de 2 à 9 salariés (sur une période de 30 jours) pour motif économique au sein d’une entreprise de moins de 1000 salariés et qui n’appartient pas à un groupe (français ou européen) employant au moins 1000 salariés.
...
UPDATE information.informations_contents_blocks
SET "content" = 'L''une de ces situations ou pathologies accroît le risque de faire une forme grave de Covid-19 et constitue **un critère de vulnérabilité**  :
...
UPDATE information.informations_contents_blocks
SET "content" = 'Les personnes vulnérables reprennent leur activité professionnelle en présentiel sous réserve de **la mise en place par l''employeur** de certaines mesures d''accompagnement, comme :
...
UPDATE information.informations_contents_blocks
SET "content" = '### Quels employeurs peuvent verser la prime ?
...
Le montant et les critères de modulation devront être précisés dans l’accord ou la décision unilatérale de l’employeur.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le grand licenciement économique, dans une entreprise avec CSE, impliquant la mise en place du contrat de sécurisation professionnelle, concerne le licenciement d’au moins 10 salariés (sur une période de 30 jours) pour motif économique au sein d’une entreprise de moins de 50 salariés et qui n’appartient pas à un groupe (français ou européen) employant au moins 1000 salariés.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le licenciement individuel pour motif économique, impliquant la mise en place du congé de reclassement, concerne le licenciement d’un seul salarié pour motif économique au sein d’une entreprise d’au moins 1000 salariés ou appartenant à un groupe (français ou européen) employant au moins 1000 salariés.
...
Si aucun poste de reclassement n’est disponible ou si le salarié refuse l’ensemble des postes proposés, l’employeur le convoque à un entretien préalable.
La convocation est réalisée par lettre recommandée avec accusé de réception (LRAR) ou remise en main propre contre décharge.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le grand licenciement économique, dans une entreprise avec CSE, impliquant la mise en place du congé de reclassement, concerne le licenciement d’au moins 10 salariés (sur une période de 30 jours) pour motif économique au sein d’une entreprise de 50 salariés et plus et qui appartient à un groupe (français ou européen) employant au moins 1000 salariés ou dans une entreprise d’au moins 1000 salariés.
...
UPDATE information.informations_contents_blocks
SET "content" = '-   La lettre d’engagement peut valoir contrat de travail si elle comprend les éléments obligatoires du contrat ;
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le licenciement individuel pour motif économique, impliquant la mise en place du contrat de sécurisation professionnelle, concerne le licenciement d’un seul salarié pour motif économique au sein d’une entreprise de moins de 1000 salariés et qui n’appartient pas à un groupe (français ou européen) employant au moins 1000 salariés.
...
UPDATE information.informations_contents_blocks
SET "content" = '- réécriture intégrale des dispositions nationales du secteur de la métallurgie ;
...
UPDATE information.informations_contents_blocks
SET "content" = '- création d’une échelle unique de classification :  18 classes d''emplois réparties dans 9 groupes d''emplois (A à I) ;
...
UPDATE information.informations_contents_blocks
SET "content" = '- instauration d’un barème unique de salaire au niveau national.'
WHERE id = 'a9cb42be-ea1b-494e-aea9-cbbc65cebeea';
UPDATE information.informations_contents_blocks
SET "content" = '- mise en place d’un régime de remboursement de frais de santé ;

- unification du régime de remboursement des frais de santé et de prévoyance.'
WHERE id = '87882692-00cf-4ff0-8c47-b1b3e8de7ba8';
UPDATE information.informations_contents_blocks
SET "content" = '**Le passe vaccinal et le passe sanitaire ne sont plus requis** dans l’ensemble des lieux où ils étaient demandés (restaurants, bars, discothèques, cinémas, théâtres, salles de spectacle, stades, foires et salons, transports interrégionaux, établissements de santé…).
...
UPDATE information.informations_contents_blocks
SET "content" = 'Les visites ont lieu sur les heures de travail ou sont rémunérées comme temps de travail effectif lorsque les rendez-vous ne peuvent pas avoir lieu pendant les heures de travail.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le salarié nouvellement recruté doit bénéficier d’une visite dans le délai de 3 mois à partir de sa prise de fonction effective : c’est la visite d’information et de prévention.
...
Pour les stagiaires, les examens médicaux obligatoires relèvent de l''établissement d''enseignement.
...
Elle est intégrée au dossier médical en santé au travail du salarié.
'
WHERE id = '716f4cf1-565e-4b98-9b88-3491b767ab79';
UPDATE information.informations_contents_blocks
SET "content" = '**Le ministère du Travail a mis fin à ses recommandations telles qu’elles figuraient dans le protocole national en entreprise**, mis en place au printemps 2020 et plusieurs fois mis à jour en fonction de la circulation du virus et de ses variants.

Un **guide repère des mesures de prévention** a été mis en ligne pour **accompagner les employeurs dans le cadre de leur obligation de sécurité** face au risque de contamination au Covid-19. [Cliquez ici](https://travail-emploi.gouv.fr/le-ministere-en-action/coronavirus-covid-19/article/guide-repere-des-mesures-de-prevention-des-risques-de-contamination-au-covid-19) pour accéder au guide repère.
...
Consultez également notre page [**Les mesures de prévention des risques de contamination en entreprise [infographie]**](https://code.travail.gouv.fr/information/en-pratique-que-doivent-faire-les-entreprises-a-partir-du-14-mars-2022-dans-le-cadre-de-lallegement-des-mesures-de-prevention-des-risques-de-contamination-au-covid-19)
'
WHERE id = '32e18977-ea15-4ca2-89bf-3ea19890f19c';
UPDATE information.informations_contents_blocks
SET "content" = '### Transmission des refus à France Travail
...
Si le salarié refuse la proposition de CDI, elle devra en informer France Travail (nouveau nom, qui remplace Pôle emploi) dans un délai d''un mois.
...
L''employeur informe France Travail en se connectant sur la [plateforme dédiée](https://www.demarches-simplifiees.fr/commencer/refus-de-cdi-informer-francetravail).
...
UPDATE information.informations_contents_blocks
SET "content" = 'Après la visite d’information et de prévention initiale, le salarié bénéficie d’un renouvellement de cette visite.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Les salariés qui bénéficient du dispositif de **suivi individuel renforcé**, ou qui ont bénéficié de ce suivi au cours de leur carrière professionnelle, sont examinés par le médecin du travail, le collaborateur médecin ou l’interne en médecine du travail au cours d’une visite médicale, le plus tôt possible après la cessation de leur exposition à des risques particuliers pour leur santé ou leur sécurité ou avant leur départ à la retraite : c’est ce que l’on appelle la surveillance post-exposition ou post-professionnelle.
...
UPDATE information.informations_contents_blocks
SET "content" = 'La visite de mi-carrière est un nouveau dispositif.
...
Au cours de cette visite, le médecin du travail, le collaborateur médecin ou l’interne en médecine du travail, peut proposer des mesures individuelles d’aménagement, d’adaptation ou de transformation du poste de travail ou des mesures d’aménagement du temps de travail.
Si l’infirmier réalise la visite, il oriente le salarié vers le médecin du travail en cas de besoin d’aménagement de poste ou du temps de travail ou en cas de risque d’inaptitude.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Cette visite concerne les salariés en **arrêt de travail de plus de 30 jours** (durée continue ou discontinue).
...
UPDATE information.informations_contents_blocks
SET "content" = 'Un examen de reprise du travail est organisé après :
...
Cette visite permet de vérifier si le poste de travail que doit reprendre le salarié ou le poste de reclassement auquel il doit être affecté est compatible avec son état de santé.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le rendez-vous de liaison est un nouveau dispositif : **ce n’est pas une visite médicale**.
...
Cette association peut se faire par tout moyen : envoi de documents, guides, flyers, ou présence physique ou à distance d’un membre de l’équipe pluridisciplinaire du service de santé au travail.
'
WHERE id = '590da655-14eb-46a0-8fe8-69b685db366e';
UPDATE information.informations_contents_blocks
SET "content" = 'Le suivi adapté concerne les salariés de moins de 18 ans, les salariés travaillant de nuit, les salariés handicapés ou titulaires d''une pension d''invalidité, les salariés exposés aux agents biologiques du groupe 2 et les salariées enceintes, venant d''accoucher ou qui allaitent.
...
Toute femme enceinte, venant d''accoucher ou qui allaite est, à tout moment si elle le souhaite, orientée sans délai vers le médecin du travail.
Cette nouvelle visite, effectuée par le médecin du travail, vise notamment à proposer, si elles sont nécessaires, des adaptations du poste ou l''affectation à d''autres postes.
'
WHERE id = '540eb9ec-d3ee-4c0e-9576-3df445d3a1d4';
UPDATE information.informations_contents_blocks
SET "content" = 'Le salarié qui occupe un poste présentant des risques particuliers pour sa santé ou sa sécurité ou pour celles de ses collègues ou même des tiers évoluant dans son environnement immédiat de travail (des sous-traitants par exemple) bénéficie d’un suivi individuel renforcé de son état de santé.

### • Que signifie « suivi individuel renforcé » ?

Cela signifie que le suivi médical repose sur plusieurs « rendez-vous » obligatoires :

**→ avant la prise de fonction** : un examen médical d’aptitude effectué par le médecin du travail, le collaborateur médecin ou l’interne en médecine du travail
(cet examen remplace la visite d’information et de prévention « classique »)
...
L’employeur établit cette liste après avis du médecin du travail et du Comité social et économique (CSE). Il doit la mettre à jour tous les ans.

**À noter :**
Lors de l’examen médical d’aptitude à l’embauche et de son renouvellement, le médecin du travail remet aux **salariés affectés à un poste à risque** un **avis d’aptitude**, **ou** un **avis d’inaptitude** **ou** un **avis d’aptitude accompagné** d’un document faisant état **de propositions de mesures individuelles**.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Les informations qui doivent être communiquées au salarié dans les 7 jours à partir de sa date d’embauche sont les suivantes :
...
UPDATE information.informations_contents_blocks
SET "content" = 'L’employeur peut envisager de licencier un de ses salariés pour un motif lié à sa personne, sans que des faits fautifs lui soient reprochés : on parle de licenciement non disciplinaire. Dans ce cas, l’employeur doit respecter la procédure suivante.
...
Lors de cet entretien, l’employeur expose au salarié les motifs de la décision envisagée et recueille ses explications. Le salarié peut être accompagné par une personne de son choix appartenant au personnel de l’entreprise ou à défaut de représentants du personnel, par un conseiller du salarié.
...
Le préavis débute dès la première présentation de la lettre au salarié et non pas lorsque ce dernier a connaissance du contenu de la lettre.
Le salarié exécute son préavis à compter de cette date, mais il peut être dispensé de l’exécuter si son employeur l’a autorisé, ou encore en cas de force majeure ou d’impossibilité d’exécution. Le salarié a droit à l’indemnité de licenciement.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Lorsqu’un employeur a connaissance de faits fautifs commis par un salarié, il peut procéder à son licenciement.
...
Le salarié exécute son préavis normalement, sauf en cas de dispense par l’employeur, cas de force majeure ou impossibilité d’exécution.
Le salarié a droit à l’indemnité de licenciement.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le petit licenciement pour motif économique dans une entreprise avec CSE, impliquant la mise en place du contrat de sécurisation professionnelle, concerne le licenciement de 2 à 9 salariés (sur une période de 30 jours) pour motif économique au sein d’une entreprise de moins de 1000 salariés et qui n’appartient pas à un groupe (français ou européen) employant au moins 1000 salariés.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le salarié qui n’aura pas reçu ces informations pourra mettre en demeure son employeur de les lui communiquer sous 7 jours calendaires (par lettre recommandée par exemple).
...
UPDATE information.informations_contents_blocks
SET "content" = 'Oui, tous les employeurs sont concernés, à l’exception des particuliers employeurs, pour les salariés dont le temps de travail ne dépasse pas 3 heures par semaine sur 4 semaines consécutives et qui utilisent le CESU (ils ne sont pas tenus de leur remettre les informations principales relatives à la relation de travail).
...
UPDATE information.informations_contents_blocks
SET "content" = 'Si le salarié n’a pu prendre tout ou partie de ses congés **au cours de la période de prise de congés en cours au moment de son arrêt de travail**, en raison de sa maladie, professionnelle ou non, il bénéficie d’un report.
...
UPDATE information.informations_contents_blocks
SET "content" = 'L’arrêt maladie du salarié, quelle que soit l’origine de cet arrêt (maladie professionnelle ou non professionnelle), ne le prive pas de droits à congés.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le salarié a droit à **2.5 jours de congés payés par mois de travail effectif** chez le même employeur, quel que soit son contrat de travail (CDI, CDD, contrat d''intérim) et qu’il travaille à temps plein ou à temps partiel.
...
UPDATE information.informations_contents_blocks
SET "content" = 'Le contrat de travail à durée déterminée est nécessairement établi par écrit et comporte la définition précise du motif du recours au CDD.
...
En toutes hypothèses, il convient de vous assurer que vous êtes dans l’un des cas de recours autorisés par la loi et d’adapter ce contrat à votre situation. Vérifiez notamment la [durée maximale prévue par la convention collective](https://code.travail.gouv.fr/contribution/quelle-peut-etre-la-duree-maximale-dun-cdd) ainsi que [les conditions de renouvellement du CDD](https://code.travail.gouv.fr/contribution/combien-de-fois-le-contrat-de-travail-peut-il-etre-renouvele).

[Consultez le modèle de CDD](https://code.travail.gouv.fr/modeles-de-courriers/contrat-de-travail-a-duree-determinee-cdd)

Attention au cas particulier du CDD d''usage qui comporte de nombreuses spécificités.
[Consultez votre convention collective sur le CDD d''usage](https://code.travail.gouv.fr/contribution/embauche-en-contrat-dextra-cdd-dusage)

Le CDD à objet défini fait également l’objet de règles particulières, présentées sur [cette fiche](https://code.travail.gouv.fr/fiche-ministere-travail/le-contrat-a-duree-determinee-a-objet-defini).

Pour finir, à la fin d''un CDD, le salarié touche dans certains cas une prime de précarité. Pour connaître le montant de cette prime, un [simulateur de l''indemnité est disponible ici](https://code.travail.gouv.fr/outils/indemnite-precarite). '
WHERE id = '38257610-c3d1-4507-a6cd-e5aff0cb25cb';
UPDATE information.informations_contents_blocks
SET "content" = 'Selon le Code du travail, la forme du contrat à durée indéterminée est libre : un écrit n’est pas nécessairement exigé s''il s''agit d''un CDI *à temps plein* sauf si votre convention collective le prévoit. Vous pouvez vérifier cette obligation [ici](https://code.travail.gouv.fr/contribution/est-il-obligatoire-davoir-un-contrat-de-travail-ecrit-et-signe).
En pratique, un contrat écrit est toujours préférable.

Par exemple, pour qu’il y ait une période d’essai, celle-ci doit être expressément indiquée dans le contrat de travail. [Vérifiez ici la durée maximale prévue par votre convention collective](https://code.travail.gouv.fr/contribution/quelle-est-la-duree-maximale-de-la-periode-dessai-sans-et-avec-renouvellement).

Par ailleurs, elle ne peut être renouvelée que si la convention collective le prévoit. [Consultez la disposition de votre convention collective sur le renouvellement de la période d''essai](https://code.travail.gouv.fr/contribution/la-periode-dessai-peut-elle-etre-renouvelee).

Ce modèle de contrat de travail à durée indéterminée vous est donc proposé à titre d’exemple. [Consultez le modèle de CDI](https://code.travail.gouv.fr/modeles-de-courriers/contrat-de-travail-a-duree-indeterminee)

Il convient de l’adapter à votre situation et d’y faire figurer les clauses imposées par votre convention collective et les éventuelles clauses particulières librement négociées (clause de non-concurrence, clause de mobilité…).
Retrouvez les **mentions obligatoires** prévues par votre convention collective [en cliquant ici](https://code.travail.gouv.fr/contribution/quelles-informations-doivent-figurer-dans-le-contrat-de-travail-ou-la-lettre-dengagement).'
WHERE id = 'bf433f1b-8852-4baa-8365-9508f5fadad0';
UPDATE information.informations_contents_blocks
SET "content" = 'L''employeur doit communiquer au salarié les informations principales relatives à la relation de travail, **par écrit**, dans un ou plusieurs documents (nécessairement différents du contrat de travail).
...
[Consultez le modèle qui permet à l’employeur de porter à la connaissance du salarié toutes les informations relatives à la relation de travail, en une seule fois](https://code.travail.gouv.fr/modeles-de-courriers/informations-principales-relatives-a-la-relation-de-travail-delivrees-au-salarie?q=informations%20principales)

 [Consultez le modèle portant sur les informations principales relatives à la relation de travail du salarié détaché](https://code.travail.gouv.fr/modeles-de-courriers/informations-principales-relatives-a-la-relation-de-travail-du-salarie-detache?q=informations%20principales)

[Consultez le modèle portant sur les informations principales relatives à la relation de travail du salarié appelé à travailler à l''étranger](https://code.travail.gouv.fr/modeles-de-courriers/informations-principales-relatives-a-la-relation-de-travail-du-salarie-appele-a-travailler-a-letranger?q=informations%20principales)
'
WHERE id = '50b497f8-9da8-49a0-bbf6-bd639b40d01c';
UPDATE information.informations_contents_blocks
SET "content" = 'Les employeurs peuvent demander aux salariés de venir travailler sur des plages horaires décalées, notamment en avançant les horaires d''ouverture de l’entreprise ou retardant dans la journée leurs heures de prise et de fin de poste.
...
Sur ce dernier point vous pouvez vous reporter à [cette fiche](https://code.travail.gouv.fr/fiche-service-public/travail-de-nuit-du-salarie-du-secteur-prive?q=travail%20de%20nuit).
...
UPDATE information.informations_contents_blocks
SET "content" = 'Il est possible de faire coïncider la période de prise des congés payés avec les JOP.
...
Plus de détails sur les congés [ici](https://code.travail.gouv.fr/fiche-service-public/conges-payes?q=fermeture%20de%20l%27entreprise%20et%20cong%C3%A9s%20pay%C3%A9s).
'
WHERE id = '4b3174c3-afb1-476f-9c70-5a4e1e58c906';
UPDATE information.informations_contents_blocks
SET "content" = '### Durées maximales de travail
...
**À noter :** Dans le but de simplifier les démarches des entreprises en matière de durée du travail, un [guichet unique](https://travail-emploi.gouv.fr/actualites/l-actualite-du-ministere/article/derogations-a-la-duree-du-travail-pendant-les-jeux-un-guichet-unique-a-la) a été créé pour centraliser les demandes.
...
Pour en savoir plus sur la durée légale du travail et sur les dérogations accordées par l''inspection du travail, vous pouvez consulter [ce document](https://code.travail.gouv.fr/fiche-ministere-travail/la-duree-legale-du-travail).

- **Durée quotidienne de travail maximale :** 10 heures - **Dérogations :** 12 heures

- **Durée hebdomadaire de travail maximale :** 48 heures - **Dérogations :** 60 heures
...
Il peut être réduit à 9 heures par voie d’accord ou sur décision administrative délivrée par les services du ministère du travail.

Les demandes de dérogation au repos quotidien devront dans la plupart des cas être accompagnées d’une demande de hausse de la durée maximale quotidienne.
...
Ainsi, le préfet de département pourra, après la mise en œuvre de consultations obligatoires, octroyer une dérogation temporaire au repos dominical, au maximum entre le 15 juin et le 30 septembre 2024.
...
Les entreprises qui souhaitent bénéficier de cette dérogation doivent remplir les deux critères cumulatifs suivants :
...
Cela concerne aussi les communes qui ont des liens importants avec ces sites notamment en raison du réseau de transport, de routes ou d''hôtels.

S’agissant de la procédure à suivre, il convient d''effectuer une demande motivée par courrier aux services de préfecture concernés ou par voie dématérialisée, selon la préfecture.

Pour en savoir plus sur les documents à transmettre, vous pouvez consulter [ce document](https://travail-emploi.gouv.fr/IMG/pdf/foire-aux-questions-derogations-au-travail-dominical-avril-2024.pdf).
...
UPDATE information.informations_contents_blocks
SET "content" = '### Un ou plusieurs entretien(s)

L''employeur et le salarié doivent se réunir à l''occasion d''au moins un entretien dont les conditions sont précisées à l’avance (date, heure, lieu). [ Voir le modèle de lettre « demande d’entretien pour une rupture conventionnelle »](https://code.travail.gouv.fr/modeles-de-courriers/demande-de-rendez-vous-en-vue-dune-rupture-conventionnelle).
...
La loi n''impose pas à la partie qui déciderait de se rétracter de motiver sa décision.
...
Cette demande de validation de la convention doit être effectuée via [le téléservice TéléRC.](https://www.telerc.travail.gouv.fr/accueil)
