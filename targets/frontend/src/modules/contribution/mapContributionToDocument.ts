...
export const mapContributionToDocument = async (
  ...
  return {
    ...
    title: document?.title ?? data.question.content, // même si généré à l'export, on set un title par défaut pour ne pas avoir une string vide dans la table document
