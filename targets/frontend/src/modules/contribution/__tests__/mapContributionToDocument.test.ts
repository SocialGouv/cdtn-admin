...
describe("mapContributionToDocument", () => {
  ...
  it("génére les champs par défaut si pas d'input doc", async () => {
    const inputContribution: ContributionsAnswers = {
      updatedAt: "2024-07-11T13:18:08.000Z",
      display_date: "2024-07-11T13:18:08.000Z",
      id: "effee3b9-84fb-4667-944b-4b1e1fd14eb5",
    ...
    const outputDoc: HasuraDocument<ContributionDocumentJson> = {
      ...
      is_published: true,
      meta_description: "",
      slug: "16-quelles-sont-les-conditions-dindemnisation-pendant-le-conge-de-maternite",
      source: "contributions",
      text: "",
      title:
        "Quelles sont les conditions d’indemnisation pendant le congé de maternité ?",
  ...
  it("génére un titre par défaut même s'il", async () => {
    const inputContribution: ContributionsAnswers = {
      updatedAt: "2024-07-11T13:18:08.000Z",
      display_date: "2024-07-11T13:18:08.000Z",
      id: "effee3b9-84fb-4667-944b-4b1e1fd14eb5",
    ...
    expect(result?.title).toEqual("Quelles sont les conditions d’indemnisation pendant le congé de maternité ?");
  });
