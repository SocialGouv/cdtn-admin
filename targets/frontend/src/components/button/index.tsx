  ...
  return (
    <BaseButton
      ...
      sx={{
        ...
        "&:hover:not([disabled])": {
          borderColor: (theme: Theme) => theme.buttons[variant].bgHover,
          color: (theme: Theme) => theme.buttons[variant].bgHover,
        },
        "&[disabled]": {
          borderColor: "muted",
          color: "muted",
        },
        bg: (theme: Theme) => theme.buttons[variant].color,
        borderColor: (theme: Theme) => theme.buttons[variant].bg,
        color: (theme: Theme) => theme.buttons[variant].bg,
      }}
    />
  );
});
...
>(function _Button({ outline, ...props }, ref) {
  return outline ? (
...
>(function _IconButton(
  { variant = "primary", size = "normal", sx, ...props },
  ref
) {
  return (
    <BaseIconButton
      ...
      sx={{
        ...defaultButtonStyles,
        "&:hover:not([disabled])": {
          bg: (theme: Theme) => theme.buttons.icon.bgHover,
          color: (theme: Theme) => theme.buttons[variant].bg,
        },
        "&[disabled]": {
          bg: "neutral",
