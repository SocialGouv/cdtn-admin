...
export const ANSWER_GENERIC_REFERENCES = Object.values(
  ANSWER_GENERIC_REFERENCE
);
...
export const ANSWER_REFERENCE_CATEGORIES = Object.values(
  ANSWER_REFERENCE_CATEGORY
);
export const ANSWER_REFERENCE_CATEGORY_OPTIONS = ANSWER_REFERENCE_CATEGORIES.map(
  (category) => ({
...
export const ANSWER_REFERENCE_STATE_OPTIONS = ANSWER_REFERENCE_STATES.map(
  (state) => ({
...
export const LEGAL_REFERENCE_CATEGORIES = Object.values(
