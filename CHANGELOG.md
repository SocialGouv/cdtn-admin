...
- **contribution:** correction lors de la dépublication d'une contribution ([#1678](https://github.com/SocialGouv/cdtn-admin/issues/1678)) ([79144e4](https://github.com/SocialGouv/cdtn-admin/commit/79144e4fd613bc70e3e293c89d91abfdeec63a49))

## [2.73.3](https://github.com/SocialGouv/cdtn-admin/compare/v2.73.2...v2.73.3) (2026-05-04)

### Bug Fixes

- updates suggestions ([#1672](https://github.com/SocialGouv/cdtn-admin/issues/1672)) ([cb811aa](https://github.com/SocialGouv/cdtn-admin/commit/cb811aa5564780c0c6742a46dab36db026f935a1))
...
- **alert:** ne pas empêcher les alertes de tourner si le site travail-emploi n'est pas disponible ([#1646](https://github.com/SocialGouv/cdtn-admin/issues/1646)) ([d1b6aad](https://github.com/SocialGouv/cdtn-admin/commit/d1b6aad14513834d2022b7259f1358cca2bbfb52))
- **deps:** mise à jour de nextjs en 16 ; react en 19 ; react-dsfr en 1.32 ([#1645](https://github.com/SocialGouv/cdtn-admin/issues/1645)) ([08c827e](https://github.com/SocialGouv/cdtn-admin/commit/08c827e71b003818f441a71db8de31f391471f75))
...
- **export:** update suggestions [#7107](https://github.com/SocialGouv/cdtn-admin/issues/7107) ([#1641](https://github.com/SocialGouv/cdtn-admin/issues/1641)) ([3628be1](https://github.com/SocialGouv/cdtn-admin/commit/3628be1b9faaa00ec2fa49c1a450773c671cab8e))
...
- **mattermost:** update deployment notification messages for clarity ([92970c6](https://github.com/SocialGouv/cdtn-admin/commit/92970c64ca7d0e938dd8ee045b4a861f37a05c89))

## [2.66.5](https://github.com/SocialGouv/cdtn-admin/compare/v2.66.4...v2.66.5) (2026-01-28)

### Bug Fixes

- **mattermost:** release ([d6e4587](https://github.com/SocialGouv/cdtn-admin/commit/d6e458730db027d336dee7c467e2859bfc6d4165))
...
- add Mattermost notification during the production deployment ([#1630](https://github.com/SocialGouv/cdtn-admin/issues/1630)) ([2815193](https://github.com/SocialGouv/cdtn-admin/commit/28151934e2fc7e46d08340d7ddde8408f6d71157))
...
- **ci:** modification des backups pour la preprod et la dev ([#1625](https://github.com/SocialGouv/cdtn-admin/issues/1625)) ([e7ab28a](https://github.com/SocialGouv/cdtn-admin/commit/e7ab28af7b4dabb9f9427a7473d0192d89a26a24))
...
- convertir les tag hn vers title et sub-title ([#1591](https://github.com/SocialGouv/cdtn-admin/issues/1591)) ([464a413](https://github.com/SocialGouv/cdtn-admin/commit/464a413937b9482580c236462d41f6f8e96aa0f2))
...
- **ci:** build prod ([ee23aa7](https://github.com/SocialGouv/cdtn-admin/commit/ee23aa72d3861fcb287d4fa0f269aa21063c7cf2))
...
- **production:** increase perfs on `hasura` ([#1548](https://github.com/SocialGouv/cdtn-admin/issues/1548)) ([0856e83](https://github.com/SocialGouv/cdtn-admin/commit/0856e83ce9998348d9380cb6cdcaee1b9999b635))

## [2.54.1](https://github.com/SocialGouv/cdtn-admin/compare/v2.54.0...v2.54.1) (2025-02-05)

### Bug Fixes

- **performance:** set better perf for cnpg-cluster ([#1546](https://github.com/SocialGouv/cdtn-admin/issues/1546)) ([29abd83](https://github.com/SocialGouv/cdtn-admin/commit/29abd832b73a423c6393fd0fe9b32e9b4dd500dd))
...
- augmentation du timeout pour l'action publish-all ([#1499](https://github.com/SocialGouv/cdtn-admin/issues/1499)) ([964ffd3](https://github.com/SocialGouv/cdtn-admin/commit/964ffd3abd8795a66b7bb68c1ee59bbd871bbeca))
...
- add publish function on list ([#1473](https://github.com/SocialGouv/cdtn-admin/issues/1473)) ([2a4808d](https://github.com/SocialGouv/cdtn-admin/commit/2a4808d6d520fcedbdecd8869ad3a691645d1ba2))
...
- remove azure config ([#1488](https://github.com/SocialGouv/cdtn-admin/issues/1488)) ([6d8c185](https://github.com/SocialGouv/cdtn-admin/commit/6d8c185569b7effa4a513d40e1dc457c57a9dfb5))
...
- dedicated nodepool ([#1465](https://github.com/SocialGouv/cdtn-admin/issues/1465)) ([7110107](https://github.com/SocialGouv/cdtn-admin/commit/71101075512f4a6768ce0d5a01c3cd21e582f399))
...
- autoscale prod ([#1409](https://github.com/SocialGouv/cdtn-admin/issues/1409)) ([32e2030](https://github.com/SocialGouv/cdtn-admin/commit/32e2030aed88aac2c96b76baba8a2e66292d213b))
...
- **contributions:** activation du lot 3 ([#1288](https://github.com/SocialGouv/cdtn-admin/issues/1288)) ([82d0d36](https://github.com/SocialGouv/cdtn-admin/commit/82d0d3685f566ddbeb0e2c8bf64eb0b2e55ef619))
...
- **scripts:** script permettant de reset l'env de dev à partir du backup ([#1279](https://github.com/SocialGouv/cdtn-admin/issues/1279)) ([ac91465](https://github.com/SocialGouv/cdtn-admin/commit/ac91465356073a6e1440c0cc86819eb58d3e6f57))
...
- **fiche-sp:** nouveau format de l'url pour les fiches pros ([#1265](https://github.com/SocialGouv/cdtn-admin/issues/1265)) ([03da701](https://github.com/SocialGouv/cdtn-admin/commit/03da7017354ad8edde07506a37eeffc9a9de7495))
...
- **ccs:** activation des CCs du lot 2 pour les nouvelles contribs ([#1166](https://github.com/SocialGouv/cdtn-admin/issues/1166)) ([384e737](https://github.com/SocialGouv/cdtn-admin/commit/384e73746a253d01090cf10b55cf4d03cf06c1f0))
- **scripts:** support de DBeaver et ajout d'un script pour dump une BDD ([#1224](https://github.com/SocialGouv/cdtn-admin/issues/1224)) ([4c3f76b](https://github.com/SocialGouv/cdtn-admin/commit/4c3f76bcfb1789f7dce83b56270abec0f9dce8a1))
...
- ajout d'un script pour faciliter la connexion à la DB sur kube ([#1190](https://github.com/SocialGouv/cdtn-admin/issues/1190)) ([2986e12](https://github.com/SocialGouv/cdtn-admin/commit/2986e1262d15acc3b0d1da0d33d2beb663ae204f))
...
- ne pas récupérer les contenus liés dépubliés ([#1147](https://github.com/SocialGouv/cdtn-admin/issues/1147)) ([2fa0af5](https://github.com/SocialGouv/cdtn-admin/commit/2fa0af52c269791c684ca232e67526193fdaa169))
...
- update replicas for export ([#1131](https://github.com/SocialGouv/cdtn-admin/issues/1131)) ([615cc15](https://github.com/SocialGouv/cdtn-admin/commit/615cc152c40c2a8bd78ca6082bfc793c23666262))
...
- **contributions:** correction des liens vers les conventions collectives ([#1126](https://github.com/SocialGouv/cdtn-admin/issues/1126)) ([7ad182f](https://github.com/SocialGouv/cdtn-admin/commit/7ad182fe434d76950e5a697490c0acfca15863e6))
...
- ajout de la 3248 ([#1094](https://github.com/SocialGouv/cdtn-admin/issues/1094)) ([fbef741](https://github.com/SocialGouv/cdtn-admin/commit/fbef7419a50216cae16e62cc5f0b0b5d53b81b5f))
...
- update npm sealed secret ([ba35f26](https://github.com/SocialGouv/cdtn-admin/commit/ba35f2659fa85334e8ca3dc48da8dcebd45cd3e6))
...
- mise à jour de l'heure du lancement de l'ingester ([#1018](https://github.com/SocialGouv/cdtn-admin/issues/1018)) ([6f41d65](https://github.com/SocialGouv/cdtn-admin/commit/6f41d6576b0b4175d32572343401d7ef35cbfd01))
...
- **workflow:** ajout du workflow quality sur master ([0ba5935](https://github.com/SocialGouv/cdtn-admin/commit/0ba59358845f6d086f97ad59c2604d5d9137e50f))
...
- **infra:** change prod performance ([#891](https://github.com/SocialGouv/cdtn-admin/issues/891)) ([1025ee4](https://github.com/SocialGouv/cdtn-admin/commit/1025ee4dec1510a2dee138331a8eeb8d873c7990))
...
- reduction des logs audits ([#888](https://github.com/SocialGouv/cdtn-admin/issues/888)) ([6f9ec89](https://github.com/SocialGouv/cdtn-admin/commit/6f9ec890016e1ce230607d3e7ddeb80d5edece18))
...
- empty commit ([3b69aa6](https://github.com/SocialGouv/cdtn-admin/commit/3b69aa6851cb645f3f44b066b947747e6e92b589))
- empty commit ([704b385](https://github.com/SocialGouv/cdtn-admin/commit/704b3859c9db8e13284270e6b0ca7f440512f059))
...
- **security:** hasura version ([#855](https://github.com/SocialGouv/cdtn-admin/issues/855)) ([88514c6](https://github.com/SocialGouv/cdtn-admin/commit/88514c6d2f1c3d328137355994892ecb87cf4687))
...
- **lerna:** upgrade to latest ([#854](https://github.com/SocialGouv/cdtn-admin/issues/854)) ([e9fcabe](https://github.com/SocialGouv/cdtn-admin/commit/e9fcabe30335bbafa7cb30dc82db1ab8a12d167d))
